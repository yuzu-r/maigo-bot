...
require_relative 'classes/trainer'
require 'chronic'
require 'tzinfo'
...
module Bot
  ...
  POLICY_CHANNEL_ID = ENV['POLICY_CHANNEL_ID'].to_i || nil
  ...
  REPORTING_START_DAY = ENV['REPORTING_START_DAY'] || 'Sunday'
  TRAIN_ACTIVE = ENV['TRAIN_ACTIVE'] || nil
  MIDNIGHT_POST_CHANNEL_ID=ENV['MIDNIGHT_POST_CHANNEL_ID'].to_i
  MIDNIGHT_POST=ENV['MIDNIGHT_POST'] || 'hi'
